...
CHECK_INTERVAL   = 10
MAX_POSITIONS    = 2      # v6.7: kleines Portfolio
MIN_ORDER_USDC   = 4.0    # v6.7: kleines Portfolio
TAKER_FEE_PCT    = 0.006
...
LONG_TRAIL_PCT   = 0.010   # v6.6: enger fuer bessere Gewinn-Sicherung
MIN_SCORE        = 9.0    # v6.7: angepasst für kleines Portfolio

# Position Sizing
BASE_RISK_PCT    = 0.26   # 77% WR v6.2
MAX_RISK_PCT     = 0.80   # v6.7: kleines Portfolio
MIN_RISK_PCT     = 0.60   # v6.7: kleines Portfolio, mehr Einsatz nötig
