...
CHECK_INTERVAL   = 10
MAX_POSITIONS    = 4      # v6.9: €200 Portfolio
...
LEARN_MAX_POS    = 3      # max gleichzeitige Lern-Trades
LEARN_REGIMES    = ("SIDEWAYS", "RECOVERY")  # wann gelernt wird

# Position Sizing
BASE_RISK_PCT    = 0.26   # 77% WR v6.2
MAX_RISK_PCT     = 0.20   # v6.9: max 20% pro Position = ~$40
MIN_RISK_PCT     = 0.08   # v6.9: min 8% = ~$16 pro Trade
...
def tg_sell(pair, price, pnl, profit, reason):
        ...
        try:
            ...
            if now_hour == 0 and daily_start_total is not None:
                if datetime.now().minute < 1:
                    ...
                    # Tages-Zusammenfassung senden
                    tg_daily_summary(
                        total=total,
                        pnl=total-(daily_start_total or total),
            ...
            if can_buy:
                ...
                is_learn_phase = (LEARN_MODE and
                                  _current_regime in LEARN_REGIMES)
